...
const CONVERT_QUIPS: Quip[] = [
  ...
  q("i won't compress your file unless you ask. the level's in the settings menu.", "idle"),
...
const CAPABILITY_QUIPS: Quip[] = [
  ...
  q("the pdf editor can compress what it saves too. check the settings menu.", "happy"),
...
const COMPRESS_QUIPS: Quip[] = [
  ...
  q("a pdf that's all text won't compress much. that's physics, not laziness.", "idle"),
